...
const CourseMaterials = memo(({ learningMaterials, setCourseData }) => {
    ...
    return JSON.stringify(prevProps.learningMaterials) === JSON.stringify(nextProps.learningMaterials);
});
