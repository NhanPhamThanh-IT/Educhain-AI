  ...
  const questions = [
    {
      ...
      answer: "PaddleOCR",
      explanation: "PaddleOCR is a specialized AI model designed specifically for Optical Character Recognition (OCR) tasks. Unlike other AI models that have broader applications, PaddleOCR focuses on accurately extracting and recognizing text from various image sources, including documents, screenshots, and photographs. Its advanced algorithms can handle multiple languages, different font styles, and complex background conditions, making it a powerful tool for text extraction in diverse scenarios."
    },
    {
...
return history !== "overview" ? (
  ...
  >
    ...
    <Typography variant="body1" mt={1}>
      This study set contains <b>10 questions</b> that were generated
